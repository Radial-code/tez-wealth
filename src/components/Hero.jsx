...
const Hero = () => {
    return (
        <section class="lg:h-[810px] overflow-x-clip bg-sky-blue lg:bg-hero-background relative bg-cover">
            <img src="./assets/images/svg/hero-ellipse.svg" alt="hero-ellipse"
                class="absolute z-[1] start-[-10px] lg:start-3 top-20 lg:top-[115px] max-w-[53px] sm:max-w-[80px] lg:max-w-[116px] animate-pulse" />
            <NavBar />
            <img src="./assets/images/webp/hero-img.webp"
                class="max-w-[50%] max-2xl:max-w-[45%] w-full z-0 absolute xl:right-0 md:right-[-55px] h-full top-0 max-lg:hidden 2xl:object-fill"
                alt="hero-img" />
            <div
                class="container px-5 lg:h-[720px] mx-auto max-w-[1180px] flex flex-wrap items-center  max-lg:h-auto max-lg:pb-3 max-custom-sm:pb-0 max-lg:pt-5">
                <div class="w-full my-auto lg:w-6/12 max-lg:text-center">
                    <p
                        class="text-light-black font-semibold text-base md:text-lg lg:text-xl font-poppins leading-150 font-poppins text-opacity-90 flex items-center max-lg:justify-center gap-3.5">
                        <svg class="size-6 md:size-[30px]" width="30" height="30" viewBox="0 0 30 30" fill="none"
                    ...
                    <h1 class="xl:text-6xl md:text-5xl text-4xl text-off-green font-poppins !leading-110 pt-5 pb-3.5 md:py-4">
                        Achieve Financial Freedom with
                        <span class="font-bold text-deep-sea-green">AI-Powered Insights</span>
                    </h1>
                    <p
                        class="font-poppins text-base md:text-lg lg:text-xl !leading-163 text-light-black text-opacity-90 max-w-[558px] max-lg:mx-auto">
                        AI-driven personal finance and wealth management for high net worth
                        individuals and HENRYs
                    </p>
                    <div class="max-lg:flex max-lg:justify-center">
                        <button
                            ...
                            <span class="relative z-0"> Get Started</span>
                        </button>
                    </div>
                </div>
                <div class="w-full lg:w-6/12 max-custom-sm:h-[380px] max-lg:h-[500px] mt-10 lg:mt-0">
                    <img src="./assets/images/webp/graph.webp"
                        class="max-w-[260px] custom-sm:max-w-[363px] md:max-w-[470px] relative lg:absolute lg:bottom-10 md:-right-[15%] lg:right-[5%] xl:right-[19%] z-[3] drop-shadow-hero-graph"
                        alt="graph" />
                    <img src="./assets/images/webp/small-hero-image.webp" alt="hero-image"
                        class="max-w-[353px] custom-sm:max-w-[450px] max-custom-sm:h-[356px] w-full lg:hidden absolute end-0 bottom-[43px]" />
                </div>
            </div>
        </section>
    )

...
const NavBar = () => {
    ...
    return (
        <nav className="py-2 sm:py-[13px] bg-nav-background bg-no-repeat bg-header lg:bg-deep-sea-green">
            <div className="containter px-5 mx-auto max-w-[1180px] flex justify-between items-center relative z-10">
                <a href="#">
                    <Image
                ...
                <ul
                    className={`flex items-center gap-4 xl:gap-6 max-lg:z-10 max-lg:justify-center max-lg:flex-col max-lg:fixed max-lg:top-0 max-lg:bg-deep-sea-green max-lg:w-full max-lg:h-screen  duration-300 ${show ? "max-lg:translate-x-full" : "max-lg:translate-x-0"
                        }`}
                >

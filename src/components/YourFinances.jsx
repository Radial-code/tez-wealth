...
const YourFinances = () => {
    return (
        <section id="contact" className="xl:pb-40 lg:pb-32 md:pb-28 pb-[100px] relative overflow-x-clip lg:bg-accordion bg-full">
            ...
            <div className="absolute lg:right-[66px] right-[-20px] lg:bottom-[41px] bottom-3"><img width="116" height="79"
            ...
            <div className="container px-5 xl:px-0 max-w-[1140px]">
                <div className="flex flex-wrap items-center justify-between">
                    ...
                    <div className="md:w-1/2 w-full xl:px-0 px-0 lg:mt-0 mt-10">
                        <Form />
                        <div id="popUp"
                            className="fixed bottom-[20px] right-[20px] bg-light-green text-white p-5 rounded-lg text-center text-lg z-50 hidden">
                            <div className="flex max-w-[300px] h-[150px]">
                                <p className="text-white text-xl my-auto py-auto leading-normal font-poppins text-center capitalize">
